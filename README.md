...
Uses the html5-qrcode library to scan codes and provides those codes to [UPCttemdb](https://www.upcitemdb.com/) for a description of the item. User is able to manually enter UPC if camera is unavailable or even enter all data manually.
